...
return new class extends Migration
{
    ...
    {
        Schema::table('educational_program_manuals', function (Blueprint $table) {
            if (!Schema::hasColumn('educational_program_manuals', 'created_at')) {
            ...
            if (!Schema::hasColumn('educational_program_manuals', 'updated_at')) {
